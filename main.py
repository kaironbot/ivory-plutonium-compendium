...
def generate_template_upload(folder: str, version: str) -> None:
    ...
    for j in os.listdir(os.path.join(base_folder, "optional_features")):
        feature = json.load(open(os.path.join(base_folder, "optional_features", j), 'r'))
        base["optionalfeature"].append(feature)
    # Add feats
